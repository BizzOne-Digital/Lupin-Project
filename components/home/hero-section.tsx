        ...
        <div className="max-w-2xl">
          ...
          >
            <Button
              asChild
              size="lg"
              className="rounded-xl gradient-primary hover:gradient-primary-hover text-white text-lg px-10 py-7 shadow-2xl font-bold hover:scale-105 transition-transform"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="rounded-xl bg-white hover:bg-gray-50 text-[#4F46E5] border-2 border-white text-lg px-10 py-7 font-bold shadow-xl hover:scale-105 transition-transform"
            >
          ...
          >
            {trustBadges.map((badge, index) => (
              <div
                key={index}
                className="flex items-center gap-2 px-5 py-3 bg-white/15 backdrop-blur-sm rounded-xl border border-white/30 shadow-lg"
              >
